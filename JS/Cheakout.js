...
// Assuming the value is already stored in localStorage
let visaAmount = localStorage.getItem('result');
...
// Check if the value exists before updating
if (visaAmount) {
  // Update the span with the amount value
  document.getElementById('amount').textContent = visaAmount;
  setTimeout(function() {
  }, 3000); // 3000 milliseconds = 3 seconds
} else {}

document.getElementById("DoneOrder").addEventListener("click", function(){
